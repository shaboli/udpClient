...
@implementation WinampController
...
- (void)viewDidLoad
{
    ...
    self.volumeControl.imagesPrefix = @"win";
    [self.volumeControl initControl];
    [self.btnPlay setImage:[UIImage imageNamed:@"win_pause_btn_s.png"] forState:UIControlStateHighlighted | UIControlStateSelected];
    
    //UISlider
    UIImage *minImage = [UIImage imageNamed:@"win_scroll_back_max.png"];
    UIImage *maxImage = [UIImage imageNamed:@"win_scroll_back.png"];
    UIImage *thumbImage = [UIImage imageNamed:@"win_scroll_thumb.png"];
...
{
    [self.navigationController.navigationBar initWithCustomStyle:self withImage:@"win_nav2_back.png" title:@"Winamp Control"];
    UICustomBarButtonItem *leftButton = [[[UICustomBarButtonItem alloc] initWithCustomStyle:[UIImage imageNamed:@"win_nav_controls_btn.png"]] autorelease];
    ...
    UICustomBarButtonItem *rightButton = [[[UICustomBarButtonItem alloc] initWithCustomStyle:[UIImage imageNamed:@"win_nav_server_btn.png"]] autorelease];
